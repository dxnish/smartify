...
<tr><td style="vertical-align:middle"><b> </b></td><td style="vertical-align:middle"><b>Name</b></td>
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($rowcount == 0) {
            ...
            if ($remaining > 0 && $qstatus == "enabled" && $status == "ongoing") {
                ...
                //continue button if ongoing
            } else {
                echo '<tr style="color:darkgreen"><td style="vertical-align:middle">' . $c++ . '</td>
                <td style="vertical-align:middle">' . $title . '&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td>
                <td style="vertical-align:middle">' . $total . '</td>
                <td style="vertical-align:middle">+' . $correct . '</td>
                <td style="vertical-align:middle">' . $correct * $total . '</td>
...
?>
<?php
//masuk rank lepas finish quiz
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['session1']) && $_SESSION['session1'] == "session1" && isset($_GET['endquiz'])== 'end') {
...
//process history
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_GET['start']) && $_GET['start'] == "start" && (!isset($_SESSION['session1']))) {
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['session1']) && $_SESSION['session1'] == "session1") {
    $q = mysqli_query($con, "SELECT * FROM history WHERE username='$username' AND eid='$_GET[eid]' ") or die('Error197');
...
<br />';
            ...
            echo '</div>';
            echo '<div class="panel" style="text-align:center color : pink">';
    ...
    //rank updated sun=tambah semua scores
        unset($_SESSION['session1']);
        $q = mysqli_query($con, "UPDATE history SET status='finished' WHERE username='$_SESSION[username]' AND eid='$_GET[eid]' ") or die('Error197');
        $q = mysqli_query($con, "SELECT * FROM history WHERE eid='$_GET[eid]' AND username='$_SESSION[username]'") or die('Error156');
                while ($row = mysqli_fetch_array($q)) {
...
if (@$_GET['q'] == 'result' && @$_GET['eid']) {
    ...
    //get data from database history
...
<center><h1 class="title" style="color:#660033">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
        echo '<tr style="color:darkblue"><td style="vertical-align:middle">Total Questions</td>
        <td style="vertical-align:middle">' . $total . '</td></tr>
      <tr style="color:darkgreen"><td style="vertical-align:middle">1 Quest Mark&nbsp;<span class="glyphicon glyphicon-ok-arrow" aria-hidden="true"></span></td>
      <td style="vertical-align:middle">' . $markah . '</td></tr> 
      <tr style="color:darkgreen"><td style="vertical-align:middle">Correct Answer&nbsp;<span class="glyphicon glyphicon-ok-arrow" aria-hidden="true"></span></td>
      <td style="vertical-align:middle">' . $r . '</td></tr> 
      <tr style="color:red"><td style="vertical-align:middle">Wrong Answer&nbsp;<span class="glyphicon glyphicon-remove-arrow" aria-hidden="true"></span></td>
      <td style="vertical-align:middle">' . $w . '</td></tr>
      <tr style="color:orange"><td style="vertical-align:middle">Unattempted&nbsp;<span class="glyphicon glyphicon-ban-arrow" aria-hidden="true"></span></td>
      <td style="vertical-align:middle">' . ($total - $r - $w) . '</td></tr>
      <tr style="color:darkblue"><td style="vertical-align:middle">Quiz Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td>
      <td style="vertical-align:middle">' . $s . '&nbsp;/'.$total*$markah.'</td></tr>';
        $q = mysqli_query($con, "SELECT * FROM rank WHERE  username='$username' ") or die('Error157');
        while ($row = mysqli_fetch_array($q)) {
            //$s = $row['score'];
            echo '<tr style="color:#990000"><td style="vertical-align:middle">%&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $r*100/$total . '&nbsp;%'.'</td></tr>';
        }
        ...
        die("You did not finished the quiz properly!");
    }
}
// my history
if (@$_GET['q'] == 2) {
...
<tr><td style="vertical-align:middle"><b> </b></td>
    ...
    <td style="vertical-align:middle"><b>Quiz Score</b></td>
    ...
    while ($row = mysqli_fetch_array($q)) {
        ...
        echo '<tr><td style="vertical-align:middle">' . $c . '</td>
                  ...
                  <td style="vertical-align:middle">' . $s . '&nbsp;/'.$total*$markah.'</td>
                  <td style="vertical-align:middle">' . $r*100/$total . ' %'. '</td>
                  <td style="vertical-align:middle"><b><a href="account.php?q=result&eid=' . $eid . '" class="btn" style="margin:0px;background:darkred;color:white">&nbsp;<span class="title1"><b>View Result</b></td></tr>';
    } 
    echo '</table></div>';
}
if (@$_GET['q'] == 3) {
    ...
    echo '<div class="panel title">
            <p> TIPS : ANSWER ALL QUIZ TO COLLECT AS MANY MARK AS YOU CAN!
            <table class="table table-striped title1" >
            ...
            <td style="vertical-align:middle"><b>Overall Attempted Quizzes Score</b></td></tr>';
    $c = $showfrom-1;
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Danish Ghani</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Developer's Information</span></h4>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="row">
        <div class="col-md-4">
         <img src="img/dev.jpg" width=100 height=100 alt="Danish" class="img-rounded">
         </div>
         <div class="col-md-5">
        <a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Danish Ghani</a>
        <h4 style="font-family:'typo' ">danishhavoc9@gmail.com</h4>
        <h4 style="font-family:'typo' ">UTeM, Melaka</h4></div></div>
        </p>
      </div>
