...
<a href="home1.php" class="pull-right btn logb btn-primary" style="color:white"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<font style="font-size:12px;font-weight:bold">Home</font></a>&nbsp;
</div></div>
...
<font style="font-size:12px;font-weight:bold"><input type="submit" name="submit" value="Submit Feedback" class="btn btn-primary" /></font>
</div>
</form>';
}
?>
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Danish Ghani<br><br></span></div>
