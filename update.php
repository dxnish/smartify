...
if (isset($_SESSION['key'])) {
    if (@$_GET['fdid'] && $_SESSION['key'] == 'mainsess') {
        $id = @$_GET['fdid'];
...
//score
if (isset($_SESSION['key'])) {
    if (@$_GET['deidquiz'] && $_SESSION['key'] == 'mainsess') {
        $eid = @$_GET['deidquiz'];
...
if (isset($_SESSION['key'])) {
    if (@$_GET['eeidquiz'] && $_SESSION['key'] == 'mainsess') {
        $eid = @$_GET['eeidquiz'];
...
if (isset($_SESSION['key'])) {
    if (@$_GET['dusername'] && $_SESSION['key'] == 'mainsess') {
...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'rmquiz' && $_SESSION['key'] == 'mainsess') {
        $eid = @$_GET['eid'];
...
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == 'mainsess') {
        $name    = $_POST['name'];
        ...
        $status  = "disabled";
        $id      = uniqid();
        $q3      = mysqli_query($con, "INSERT INTO quiz VALUES(NULL,'$id','$name','$correct','$total','$time', 'NOW()','$status')");
        header("location:admin.php?q=4&step=2&eid=$id&n=$total");
    }
}
if (isset($_SESSION['key'])) {
    if (@$_GET['q'] == 'addqns' && $_SESSION['key'] == 'mainsess') {
        $n   = @$_GET['n'];
        $eid = @$_GET['eid'];
        $ch  = @$_GET['ch'];
        for ($i = 1; $i <= $n; $i++) {
            $qid  = uniqid(rand(), true);
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['session1']) && $_SESSION['session1'] == "session1" && isset($_POST['ans']) && (!isset($_GET['delanswer']))) {
    $eid   = @$_GET['eid'];
    $sn    = @$_GET['n'];
    $total = @$_GET['t'];
    $ans   = $_POST['ans'];
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_SESSION['session1']) && $_SESSION['session1'] == "session1" && (!isset($_POST['ans'])) && (isset($_GET['delanswer'])) && $_GET['delanswer'] == "delanswer") {
    $eid   = @$_GET['eid'];
    $sn    = @$_GET['n'];
    $total = @$_GET['t'];
    $qid   = @$_GET['qid'];
